...
const initialize = () => {
  ...
  setContractButton.onclick = async () => {
    contractStatus.innerHTML = "Setting Crypto transaction Address";
    let isAddress;
    try {
    ...
    if (isAddress) {
      ...
      depositButton.disabled = false;
      withdrawButton.disabled = false;
      contractStatus.innerHTML = "Crypto transaction Address sucessfully changed!";
    }
  };

  depositButton.onclick = async () => {
    contractStatus.innerHTML = "Depositing 0.002 ETH to Crypto transaction";
    const accounts = await ethereum.request({ method: "eth_accounts" });
  ...
  withdrawButton.onclick = async () => {
    contractStatus.innerHTML = "Withdrawing 0.002 ETH from Crypto transaction";
    const accounts = await ethereum.request({ method: "eth_accounts" });
    await window.contract.methods
